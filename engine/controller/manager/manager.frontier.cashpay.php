<?php
/***************************************************************************************
* Module Name			:	관리자 - 프론티어 당첨자 캐시지급
* Created Date			:	2011.11.10
* Created by				:	RevU 박상선 
* Modify History			:   
****************************************************************************************/
...
// 게시물리스트
$list = $CLASS_FRONTIER->AdminCashgetList($DB, $code, $btitle, $sch_opt, $sch_con, $CLASS_PAGE->getLimit(), $stat, $frname);
