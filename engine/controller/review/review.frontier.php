...
$cnt = $CLASS_REVIEW->getReviewCount($DB, $type="F", $cate, $status="1", $date="");
$list = $CLASS_REVIEW->getReviewList($DB, $limit, $type="F", $cate, $status="1", $date="", Module::$param[2], Module::$param[3]);
