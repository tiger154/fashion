...
class Email {
	...
	var	$charset2		= "euc-kr";	// Default char set: iso-8859-1 or us-ascii
	...
	private function _prep_q_encoding($str, $from = FALSE)
	{
		...
		for ($i = 0, $length = strlen($str); $i < $length; $i++)
		{
			...
			if ($ascii < 33 OR $ascii > 126 OR in_array($char, $convert))
			{
				$char = '='.dechex($ascii);
			}
