<?php /* Template_ 2.2.4 2012/12/06 10:07:18 /www/fassion10/engine/view/V3.9/_global_layer/login.htm 000002295 */ ?>
<!-- 로그인 팝업 -->
<ul>
	<li class="title">
				...
				<div class="login_input_line">
					<ul>
						<li style="padding:6px 0 3px 37px;">
							<input type="text" name="login_userid2" id="login_userid2" value="<?php echo $_COOKIE["userid"]?>" class="input_trans" />
						</li>
						<li style="padding:10px 0 3px 37px;">
							<input type="password" name="login_passwd2" id="login_passwd2" value="" class="input_trans" />
						</li>
					</ul>
				</div>
				<div class="login_but">
					<img src="/images/common/but/but_login.gif" alt="로그인" title="로그인" style="margin-left:35px;" onClick="login.login('login_userid2','login_passwd2', 'login_saveid2', '<?php echo $TPL_VAR["REQUEST_URI"]?>');" class='btn' />
				</div>
			</li>
			<li class="clear"></li>
