<?php /* Template_ 2.2.4 2011/12/09 16:48:57 /www/revu39/engine/view/V3.9/manager/manager.frontier.modify.ndate.htm 000002473 */ 
...
<?php if($TPL_startday_1){foreach($TPL_VAR["startday"] as $TPL_V1){?><option value="<?php echo $TPL_V1?>"><?php echo $TPL_V1?></option><?php }}?>
	...
	<table width="100%" border="0">
		<tr>
			<td width="100%">&nbsp;
				<center>
				<input type="button" id="modifyCheck_ndate" value="변경"/>
				</center>
			</td>
		</tr>
	</table>
